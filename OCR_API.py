...
def extract(median, dilation, csvfile):
...
def ocr():
   if request.method == 'POST':
      try:
         ...
         if 'file2' not in request.files:
            raise error_handle('Bounding Box Data is required!') # BoundingBoxData.csv file to be inputted
         ...
         return success_handle(extract(median, dilation, file2))
   ...
   return '''
      <!DOCTYPE HTML>
      <title>OCR API</title>
      <h1>Upload image and Bounding Box Data CSV File</h1>
